Operator instruction resource for workbench design_candidate_authoring.

## Workbench
Display name: Design Candidate Authoring
...
- Respect posture constraint: requires_ready_ch.
